...
//            guard let transaction = contract.createReadOperation("rentPrice", parameters: [name, duration] as [AnyObject], extraData: Data()) else { throw Web3Error.transactionSerializationError }
...
//            guard let transaction = contract.createReadOperation("valid", parameters: [name] as [AnyObject], extraData: Data()) else { throw Web3Error.transactionSerializationError }
//            guard let result = try? await transaction.callContractMethod() else { throw Web3Error.processingError(desc: "Can't call transaction") }
...
//            guard let transaction = contract.createReadOperation("available", parameters: [name as AnyObject], extraData: Data()) else { throw Web3Error.transactionSerializationError }
//            guard let result = try? await transaction.callContractMethod() else { throw Web3Error.processingError(desc: "Can't call transaction") }
...
//            guard let transaction = contract.createReadOperation("makeCommitment", parameters: [name, owner.address, secret] as [AnyObject], extraData: Data()) else { throw Web3Error.transactionSerializationError }
//            guard let result = try? await transaction.callContractMethod() else { throw Web3Error.processingError(desc: "Can't call transaction") }
...
//            defaultOptions.to = address
//            guard let transaction = contract.createWriteOperation("commit", parameters: [commitment as AnyObject], extraData: Data()) else { throw Web3Error.transactionSerializationError }
//            return transaction
//        }
//
...
//            defaultOptions.from = from
//            defaultOptions.to = address
//            guard let transaction = contract.createWriteOperation("register", parameters: [name, owner.address, duration, secret] as [AnyObject], extraData: Data()) else { throw Web3Error.transactionSerializationError }
//            return transaction
//        }
//
...
//            defaultOptions.from = from
//            defaultOptions.to = address
//            guard let transaction = contract.createWriteOperation("renew", parameters: [name, duration] as [AnyObject], extraData: Data()) else { throw Web3Error.transactionSerializationError }
//            return transaction
//        }
//
...
//            defaultOptions.from = from
//            defaultOptions.to = address
//            guard let transaction = contract.createWriteOperation("withdraw", parameters: [AnyObject](), extraData: Data()) else { throw Web3Error.transactionSerializationError }
//            return transaction
//        }
//    }
//}
