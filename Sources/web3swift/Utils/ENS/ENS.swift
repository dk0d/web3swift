...
//        guard resolver.web3.provider.url == web3.provider.url else {
...
//        guard let resolver = try? await registry.getResolver(forDomain: domain) else {
...
//        guard baseRegistrar.web3.provider.url == web3.provider.url else {
...
//        guard registrarController.web3.provider.url == web3.provider.url else {
...
//        guard reverseRegistrar.web3.provider.url == web3.provider.url else {
//            throw Web3Error.processingError(desc: "Registrar controller should use same provider as ENS")
//        }
...
//        guard let resolver = try? await registry.getResolver(forDomain: node) else {
