...
//        }
//
//        override public init(web3: Web3, provider: Web3API, address: EthereumAddress, transaction: CodableTransaction = .emptyTransaction) {
...
//            guard let transaction = contract.createWriteOperation("addController", parameters: [controllerAddress as AnyObject], extraData: Data()) else { throw Web3Error.transactionSerializationError }
//            return transaction
//        }
//
//        @available(*, message: "Available for only owner")
...
//            defaultOptions.from = from
//            defaultOptions.to = address
//            guard let transaction = contract.createWriteOperation("removeController", parameters: [controllerAddress as AnyObject], extraData: Data()) else { throw Web3Error.transactionSerializationError }
//            return transaction
//        }
//
//        @available(*, message: "Available for only owner")
...
//            defaultOptions.from = from
//            defaultOptions.to = address
//            guard let transaction = contract.createWriteOperation("setResolver", parameters: [resolverAddress as AnyObject], extraData: Data()) else { throw Web3Error.transactionSerializationError }
//            return transaction
//        }
//
//        public func getNameExpirity(name: BigUInt) async throws -> BigUInt {
//            guard let transaction = contract.createReadOperation("nameExpires", parameters: [name as AnyObject], extraData: Data()) else { throw Web3Error.transactionSerializationError }
...
//            defaultOptions.from = from
//            defaultOptions.to = address
//            guard let transaction = contract.createWriteOperation("reclaim", parameters: [record as AnyObject], extraData: Data()) else { throw Web3Error.transactionSerializationError }
//            return transaction
//        }
//    }
//}
