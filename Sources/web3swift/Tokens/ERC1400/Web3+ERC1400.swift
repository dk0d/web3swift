...
//    }
//
//    public init(address: EthereumAddress, abi: String = Web3.Utils.erc1400ABI, transaction: CodableTransaction = .emptyTransaction) {
...
//    }
//
//    public func getAllowance<API: Web3API>(originalOwner: EthereumAddress, delegate: EthereumAddress, provider: Web3Provider<API>) async throws -> BigUInt {
//        let contract = contract(with: provider)
//        transaction.callOnBlock = .latest
...
//        .createReadOperation("decimals", network: provider.api.network)!
