...
public typealias Web3Contract = Web3.Contract
...
extension Web3Provider {
    ...
    public func contract(
        ...
        Web3Contract(abiString: abiString, at: at, abiVersion: abiVersion)
    }
...
extension Web3 {
    ...
    public class Contract {
        ...
        public func prepareDeploy(
            ...
            // MARK: Writing Data flow
            guard let data = contract.deploy(bytecode: bytecode,
        ...
        ///
        /// Returns a "Transaction intermediate" object.
        public func createReadOperation(
        ...
        ///
        /// Returns a "Transaction intermediate" object.
        public func createWriteOperation(
            _ method: String = "fallback",
            chain: Chain? = nil,
            parameters: [AnyObject] = [AnyObject](),
            extraData: Data = Data()
