...
class ABIEncoderTest: XCTestCase {
    ...
    func test_soliditySha3() throws {
        var hex = try ABIEncoder.soliditySha3(true).toHexString().add0x
        assert(hex == "0x5fe7f977e71dba2ea1a68e21057beebb9be2ac30c6410aa38d4f3fbe41dcffd2")
        hex = try ABIEncoder.soliditySha3(-10).toHexString().add0x
        assert(hex == "0xd6fb717f7e270a360f5093ce6a7a3752183e89c9a9afe5c0cb54b458a304d3d5")
        hex = try ABIEncoder.soliditySha3(Data.fromHex("0xfff23243")!).toHexString().add0x
        assert(hex == "0x0ee4597224d3499c72aa0c309b0d0cb80ff3c2439a548c53edb479abfd6927ba")
        hex = try ABIEncoder.soliditySha3(UInt(234564535)).toHexString().add0x
        assert(hex == "0xb2daf574dc6ceac97e984c8a3ffce3c1ec19e81cc6b18aeea67b3ac2666f4e97")

        hex = try ABIEncoder.soliditySha3([UInt(234564535), Data.fromHex("0xfff23243")!, true, -10]).toHexString().add0x
        assert(hex == "0x3e27a893dc40ef8a7f0841d96639de2f58a132be5ae466d40087a2cfa83b7179")

        hex = try ABIEncoder.soliditySha3("Hello!%").toHexString().add0x
        ...
        hex = try ABIEncoder.soliditySha3(0xea).toHexString().add0x
        assert(hex == "0x61c831beab28d67d1bb40b5ae1a11e2757fa842f031a2d0bc94a7867bc5d26c2")

        hex = try ABIEncoder.soliditySha3(234).toHexString().add0x
        assert(hex == "0x61c831beab28d67d1bb40b5ae1a11e2757fa842f031a2d0bc94a7867bc5d26c2")

        hex = try ABIEncoder.soliditySha3(UInt64(234)).toHexString().add0x
        assert(hex == "0x6e48b7f8b342032bfa46a07cf85358feee0efe560d6caa87d342f24cdcd07b0c")

        hex = try ABIEncoder.soliditySha3(UInt(234)).toHexString().add0x
        assert(hex == "0x61c831beab28d67d1bb40b5ae1a11e2757fa842f031a2d0bc94a7867bc5d26c2")

        hex = try ABIEncoder.soliditySha3("0x407D73d8a49eeb85D32Cf465507dd71d507100c1").toHexString().add0x
        assert(hex == "0x4e8ebbefa452077428f93c9520d3edd60594ff452a29ac7d2ccc11d47f3ab95b")

        hex = try ABIEncoder.soliditySha3(Data.fromHex("0x407D73d8a49eeb85D32Cf465507dd71d507100c1")!).toHexString().add0x
        assert(hex == "0x4e8ebbefa452077428f93c9520d3edd60594ff452a29ac7d2ccc11d47f3ab95b")

        hex = try ABIEncoder.soliditySha3(EthereumAddress("0x407D73d8a49eeb85D32Cf465507dd71d507100c1")!).toHexString().add0x
        assert(hex == "0x4e8ebbefa452077428f93c9520d3edd60594ff452a29ac7d2ccc11d47f3ab95b")
        ...
        hex = try ABIEncoder.soliditySha3(Int8(-23)).toHexString().add0x
        assert(hex == "0xdc046d75852af4aea44a770057190294068a953828daaaab83800e2d0a8f1f35")

        hex = try ABIEncoder.soliditySha3(EthereumAddress("0x85F43D8a49eeB85d32Cf465507DD71d507100C1d")!).toHexString().add0x
        assert(hex == "0xe88edd4848fdce08c45ecfafd2fbfdefc020a7eafb8178e94c5feaeec7ac0bb4")

        hex = try ABIEncoder.soliditySha3(["Hello!%", Int8(-23), EthereumAddress("0x85F43D8a49eeB85d32Cf465507DD71d507100C1d")!]).toHexString().add0x
    ...
    func test_abiEncoding_emptyValues() {
        ...
        XCTAssertTrue("0xe16b4a9b" == encodedFunction?.toHexString().add0x.lowercased())
    }
}
